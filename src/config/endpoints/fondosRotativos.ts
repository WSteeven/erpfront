...
export const fondosRotativos = {
  ...
  cambiar_autorizador_gasto: new Endpoint('fondos-rotativos/cambiar-autorizador-gasto/'),
  aprobar_transferencia: new Endpoint('fondos-rotativos/aprobar-transferencia'),
  ...
  consolidado_filtrado: new Endpoint('fondos-rotativos/consolidado-filtrado/'),
