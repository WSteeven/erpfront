      ...
      <q-form @submit.prevent>
        ...
        <div class="row q-col-gutter-sm q-py-md">
          ...
          <div class="col-12 col-md-6">
            ...
            <file-component v-model="plantilla.url" clave="url" :v$="v$" />
          </div>
          {{ v$.$errors }} - {{ plantilla }}
          <!--          &lt;!&ndash; Url &ndash;&gt;-->
          <!--          <div class="col-12 col-md-6" v-if="!accion === acciones.nuevo">-->
          <!--            <label class="q-mb-sm block">Url</label>-->
          <!--            <q-input-->
          ...
          <!--              :mixin="mixin2"-->
          <!--              :endpoint="endpoint"-->
          <!--              :disable="[acciones.nuevo, acciones.editar].includes(accion)"-->
          <!--              :permitir-eliminar-->
...
<script src="./PlantillaBlasePage.ts" />
