<template>
  <tab-layout :mixin="mixin" :configuracionColumnas="configuracionColumnas" titulo-pagina="Empleados">
    <template #formulario>
      <q-form @submit.prevent>
        ...
        <q-expansion-item class="overflow-hidden q-mb-md expansion" label="Información de inicio de sesión"
          ...
          <div class="row q-col-gutter-sm q-pa-sm">
            ...
            <div class="col-12 col-md-3">
              ...
              <q-input v-model="empleado.usuario" placeholder="Obligatorio" :disable="disabled"
                :error="!!v$.usuario.$errors.length" @blur="v$.usuario.$touch" outlined dense>
            ...
            <div class="col-12 col-md-3">
              ...
              <q-input type="email" v-model="empleado.email" placeholder="Obligatorio" :disable="disabled"
                :error="!!v$.email.$errors.length" @blur="v$.email.$touch"
                @update:model-value="(v) => (empleado.email = v.toLowerCase())" outlined dense>
                <template v-slot:error>
            ...
            <div class="col-12 col-md-3">
              ...
              <q-input :type="isPwd ? 'password' : 'text'" v-model="empleado.password" placeholder="Obligatorio"
            ...
            <div class="col-12 col-md-3">
              ...
              <q-toggle :label="empleado.estado ? 'ACTIVO' : 'INACTIVO'" v-model="empleado.estado" color="primary"
                keep-color icon="bi-check2-circle" unchecked-icon="clear" :disable="disabled" />
            </div>
          </div>
          <!--</q-card> -->
        </q-expansion-item>

        <q-expansion-item class="overflow-hidden q-mb-md expansion" label="Datos personales del trabajador"
          header-class="text-bold bg-header-collapse" default-opened>
          <!-- Identificación -->
          <div class="row q-col-gutter-sm q-pa-sm">
            <div class="col-12 col-md-3">
              <label class="q-mb-sm block">Identificación</label>
              <q-input v-model="empleado.identificacion" placeholder="Obligatorio" :disable="disabled"
                :error="!!v$.identificacion.$errors.length" @blur="v$.identificacion.$touch" outlined dense>
                <template v-slot:error>
            ...
            <div class="col-12 col-md-3">
              ...
              <q-input v-model="empleado.nombres" placeholder="Obligatorio" :disable="disabled"
                :error="!!v$.nombres.$errors.length" @blur="v$.nombres.$touch" outlined dense>
                <template v-slot:error>
            ...
            <div class="col-12 col-md-3">
              ...
              <q-input v-model="empleado.apellidos" placeholder="Obligatorio" :disable="disabled"
                :error="!!v$.apellidos.$errors.length" @blur="v$.apellidos.$touch" outlined dense>
                <template v-slot:error>
            ...
            <div class="col-12 col-md-3">
              ...
              <q-input type="tel" v-model="empleado.telefono" placeholder="Obligatorio" :disable="disabled"
                :error="!!v$.telefono.$errors.length" @blur="v$.telefono.$touch" outlined dense>
                <template v-slot:error>
            ...
            <div class="col-12 col-md-3">
              ...
              <q-input type="email" v-model="empleado.correo_personal" placeholder="Obligatorio" :disable="disabled"
                ...
                @update:model-value="(v) => (empleado.correo_personal = v.toLowerCase())" outlined dense>
                <template v-slot:error>
            ...
            <div class="col-12 col-md-3 q-mb-md">
              ...
              <q-select v-model="empleado.estado_civil" :options="estado_civiles" transition-show="jump-up"
                ...
                hint="Opcional" :option-value="(v) => v.id" :option-label="(v) => v.nombre" emit-value map-options>
                <template v-slot:error>
            ...
            <div class="col-12 col-md-3">
              ...
              <q-input type="tel" mask="(xx) xxx xxxx" hint="(xx) xxx xxxx" fill-mask v-model="empleado.convencional"
                placeholder="Obligatorio" :disable="disabled" outlined dense>
              </q-input>
            </div>
                ...
                <template v-slot:append>
                  <q-icon name="event" class="cursor-pointer">
                    <q-popup-proxy cover transition-show="scale" transition-hide="scale">
                      <q-date v-model="empleado.fecha_nacimiento" :mask="maskFecha" today-btn>
            ...
            <div class="col-12 col-md-3 q-mb-md">
              ...
              <q-select v-model="empleado.canton" :options="opciones_cantones" transition-show="jump-up"
                transition-hide="jump-down" :disable="disabled" options-dense dense outlined :input-debounce="0" use-input
                @filter="filtroCantones" hint="Opcional" :option-value="(v) => v.id" :option-label="(v) => v.canton"
            ...
            <div class="col-12 col-md-3">
              ...
              <selector-imagen file_extensiones=".jpg, image/*" :imagen="empleado.foto_url" :alto="'400px'"
                @update:model-value="(data) => (empleado.foto_url = data)"></selector-imagen>
            </div>
          </div>
          <div class="col-12 col-md-12 q-ma-sm">
            <q-expansion-item class="overflow-hidden q-mb-md expansion" label="Datos adicionales"
              header-class="text-bold bg-header-collapse" default-opened>
              <div class="row q-col-gutter-sm q-pa-sm">
                <!-- Casa propia -->
                <div class="col-12 col-md-3">
                  <label class="q-mb-sm block">La casa donde vive es</label>
                  <q-toggle :label="empleado.casa_propia ? 'PROPIA' : 'ALQUILADA'" v-model="empleado.casa_propia"
                ...
                <div class="col-12 col-md-3">
                  ...
                  <q-toggle :label="empleado.vive_con_discapacitados ? 'SI' : 'NO'"
                    v-model="empleado.vive_con_discapacitados" color="primary" keep-color icon="bi-check2-circle"
                    unchecked-icon="clear" :disable="disabled" />
                </div>
                <!-- Casa propia -->
                <div class="col-12 col-md-3">
                  <label class="q-mb-sm block">Tiene a su cargo personas discapacitadas</label>
                  <q-toggle :label="empleado.responsable_discapacitados ? 'SI' : 'NO'"
                    v-model="empleado.responsable_discapacitados" color="primary" keep-color icon="bi-check2-circle"
                    unchecked-icon="clear" :disable="disabled" />
                </div>
                <!-- Vive con discapacitados -->
                <div class="col-12 col-md-3">
        ...
        <q-expansion-item class="overflow-hidden q-mb-md expansion" label="Información laboral"
          header-class="text-bold bg-header-collapse" default-opened>
          <div class="row q-col-gutter-sm q-pa-sm">
            <!-- Jefe -->
            <div class="col-12 col-md-3 q-mb-md">
              <label class="q-mb-sm block">Jefe inmediato</label>
              <q-select v-model="empleado.jefe" :options="opciones_empleados" transition-show="jump-up"
                transition-hide="jump-down" :disable="disabled" options-dense dense outlined
                :error="!!v$.jefe.$errors.length" @blur="v$.jefe.$touch" error-message="Debes seleccionar un jefe"
                use-input input-debounce="0" @filter="filtroEmpleados" :option-value="(v) => v.id"
            ...
            <div class="col-12 col-md-3">
              ...
              <q-select v-model="empleado.cargo" :options="opciones_cargos" transition-show="jump-up"
                transition-hide="jump-down" :disable="disabled" options-dense dense outlined use-input input-debounce="0"
                @filter="filtroCargos" :error="!!v$.cargo.$errors.length" error-message="Debes seleccionar un cargo"
                :option-value="(v) => v.id" :option-label="(v) => v.nombre" emit-value map-options>
                <template v-slot:error>
            ...
            <div class="col-12 col-md-3">
              ...
              <q-select v-model="empleado.roles" :options="opciones_roles" transition-show="jump-up"
                ...
                :option-value="(v) => v.name" :option-label="(v) => v.name" emit-value map-options>
            ...
            <div class="col-12 col-md-3 q-mb-md">
              ...
              <q-select v-model="empleado.nivel_academico" :options="niveles_academicos" transition-show="jump-up"
                transition-hide="jump-down" :disable="disabled" options-dense dense outlined :input-debounce="0" use-input
                hint="Opcional" :option-value="(v) => v.nombre" :option-label="(v) => v.nombre" emit-value map-options>
                <template v-slot:error>
            ...
            <div class="col-12 col-md-3">
              ...
              <q-input v-model="empleado.fecha_ingreso" placeholder="Obligatorio"
                ...
                <template v-slot:append>
                  <q-icon name="event" class="cursor-pointer">
                    <q-popup-proxy cover transition-show="scale" transition-hide="scale">
                      <q-date v-model="empleado.fecha_ingreso" :mask="maskFecha" today-btn>
                        <div class="row items-center justify-end">
                          <q-btn v-close-popup label="Cerrar" color="primary" flat />
                        </div>
                      </q-date>
                ...
                <template v-slot:error>
                  <div style="clear: inherit" v-for="error of v$.fecha_ingreso.$errors" :key="error.$uid">
                    <div class="error-msg">{{ error.$message }}</div>
                  </div>
                </template>
              </q-input>
            ...
            <div class="col-12 col-md-3">
              ...
              <q-input v-model="empleado.fecha_salida" placeholder="Obligatorio" :error="!!v$.fecha_salida.$errors.length"
                ...
                <template v-slot:error>
                  <div style="clear: inherit" v-for="error of v$.fecha_salida.$errors" :key="error.$uid">
                    <div class="error-msg">{{ error.$message }}</div>
                  </div>
                </template>
              </q-input>
            ...
            <div v-if="empleado.tiene_grupo" class="col-12 col-md-3 q-mb-md">
              ...
              <q-select v-model="empleado.grupo" :options="listadosAuxiliares.grupos" transition-show="jump-up"
                transition-hide="jump-down" :disable="disabled" options-dense dense outlined clearable
                :error="!!v$.grupo.$errors.length" @blur="v$.grupo.$touch" :option-value="(v) => v.id"
            ...
            <div class="col-12 col-md-3">
              ...
              <selector-imagen file_extensiones=".jpg, image/*" :imagen="empleado.firma_url" :alto="'80px'"
                @update:model-value="(data) => (empleado.firma_url = data)"></selector-imagen>
            </div>
            <!-- Telefono de la empresa -->
            <div class="col-12 col-md-3">
              <label class="q-mb-sm block">Teléfono empresa</label>
              <q-input type="tel" mask="##########" v-model="empleado.telefono_empresa" placeholder="Opcional"
                :disable="disabled" outlined dense>
              </q-input>
            </div>
            <!-- Extensión -->
            <div class="col-12 col-md-3">
              ...
              <q-input type="tel" mask="####" v-model="empleado.extension" placeholder="Opcional" :disable="disabled"
                outlined dense>
              </q-input>
            </div>
            <!-- Observacion -->
