  ...
  >
    <template #formulario>
      <q-form @submit.prevent>
        <div class="row q-col-gutter-sm q-mb-md q-mt-md q-mx-md q-py-sm" v-if="false">
          <!--Periodos -->
          ...
          <div class="col-12 col-md-3">
            ...
            <q-input
              v-model="vacacion.numero_rangos"
              :disable="disabled"
          ...
          <!-- Fecha Inicio -->
          <div class="col-12 col-md-3" v-if="vacacion.numero_rangos == 1">
        ...
        <div class="row q-col-gutter-sm q-mb-md q-mt-md q-mx-md q-py-sm" v-else>
          <div class="col-12 col-md-3">
          <q-btn color="primary">Tienes unas vacaciones planificadas, confirma oe...</q-btn>
          </div>
          <!--Periodos -->
          <div class="col-12 col-md-3">
            <label class="q-mb-sm block">Periodo</label>
...
<script src="./SolicitudVacacionPageOld.ts"></script>
