      ...
      <q-form @submit.prevent>
        <div class="row q-col-gutter-sm q-py-md">
          ...
          <div class="col-12 col-md-3">
            ...
            <q-input
              v-model="publicacionPuestoTrabajo.nombre"
              @update:model-value="
                (v) => (publicacionPuestoTrabajo.nombre = removeAccents(v))
              "
          ...
          <div class="col-12 col-md-3 col-sm-3">
            ...
            <q-select
              v-model="publicacionPuestoTrabajo.tipo_puesto"
          ...
          <div class="col-12 col-md-3">
            ...
            <imagen-comprimida-component
              :imagen="publicacionPuestoTrabajo.imagen_referencia"
              file_extensiones=".jpg, image/*"
              @update:modelValue="
                (data) => (publicacionPuestoTrabajo.imagen_referencia = data)
              "
            >
              <template v-slot:error>
          ...
          <div class="col-12 col-md-3">
            ...
            <imagen-comprimida-component
              :imagen="publicacionPuestoTrabajo.publicidad"
              file_extensiones=".jpg, image/*"
              @update:modelValue="(data) => (publicacionPuestoTrabajo.publicidad = data)"
            >
              <template v-slot:error>
          ...
          <div class="col-12 col-md-3">
            ...
            <q-input
              v-model="publicacionPuestoTrabajo.numero_postulantes"
              placeholder="Obligatorio"
              disable
              outlined
              dense
          ...
          <div class="col-12 col-md-3">
            ...
            <q-input
              v-model="publicacionPuestoTrabajo.fecha_caducidad"
              placeholder="Obligatorio"
          ...
          <div class="col-12 col-md-12">
            ...
            <essential-editor
              v-model="publicacionPuestoTrabajo.descripcion_vacante"
              :disable="disabled"
            >
            </essential-editor>
            <div
          ...
          <div class="col-12 col-md-3 col-sm-12">
            ...
            <essential-table
              ...
              :datos="publicacionPuestoTrabajo.conocimientos"
              ...
              :grid="false"
              :accion1="btnEliminarConocimiento"
              :alto-fijo="false"
              :ajustarCeldas="true"
            >
            </essential-table>
          ...
          <div class="col-12 col-md-3 col-sm-12">
            ...
            <essential-table
              ...
              :datos="publicacionPuestoTrabajo.formaciones_academicas"
              :permitirConsultar="false"
              :permitirEliminar="false"
              :permitirEditar="false"
              :mostrarBotones="false"
          ...
          <div class="col-12 col-md-3">
            ...
            <q-input
              v-model="publicacionPuestoTrabajo.anios_experiencia"
              placeholder="Obligatorio"
              type="number"
              :disable="disabled"
...
<script src="./PublicacionPuestoTrabajoPage.ts"></script>
