      ...
      <q-form @submit.prevent>
        <div class="row q-col-gutter-sm q-mb-md">
          ...
          <div class="col-12 col-md-2 q-mb-md">
            ...
            <q-input v-model="cambiarContrasena.current_password" placeholder="Obligatorio"
              ...
              <template v-slot:append>
                <q-icon :name="isPwdCurent ? 'visibility_off' : 'visibility'" class="cursor-pointer"
          ...
          <div class="col-12 col-md-2 q-mb-md">
            ...
            <q-input v-model="cambiarContrasena.password" placeholder="Obligatorio" :error="!!v$.password.$errors.length"
              :disable="disabled" outlined dense :type="isPwd ? 'password' : 'text'">
              <template v-slot:append>
          ...
          <div class="col-12 col-md-2 q-mb-md">
            <label class="q-mb-sm block">Contraseña actual</label>
            <q-input v-model="cambiarContrasena.password_confirmation" placeholder="Obligatorio"
              :error="!!v$.password_confirmation.$errors.length" :disable="disabled" outlined dense
