<template>
    <tab-layout :mixin="mixin" :configuracionColumnas="configuracionColumnas" titulo-pagina="Pisos">
        <template #formulario>
                ...
                <div class="row q-col-glutter-sm q-py-md">
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <q-input v-model="piso.columna" placeholder="Obligatorio" :readonly="disabled"
                            :error="!!v$.columna.$errors.length"
                            @update:model-value="(v)=>(piso.columna=v.toUpperCase())" outlined dense>
                            <template v-slot:error>
                                <div v-for="error of v$.columna.$errors" :key="error.$uid">
                                    <div class="error-msg">{{error.$message}}</div>
                                </div>
                            </template>
                        </q-input>
