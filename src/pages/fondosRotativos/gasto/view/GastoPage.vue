    ...
    <template #formulario>
      <q-form @submit.prevent>
        <div class="row q-col-gutter-sm q-mb-md">
              ...
              <template v-slot:append>
                <q-icon name="event" class="cursor-pointer">
                  <q-popup-proxy cover transition-show="scale" transition-hide="scale">
                    <q-date v-model="gasto.fecha_viat" mask="DD-MM-YYYY" today-btn>
          ...
          <!-- Tareas -->
          <div class="col-12 col-md-4 q-mb-md" v-if="gasto.proyecto >= 0">
            <label class="q-mb-sm block">Tareas</label>
            <q-select v-model="gasto.num_tarea" :options="tareas" transition-show="jump-up" transition-hide="jump-down"
          ...
          <div class="col-12 col-md-3">
            ...
            <div class="col-12 col-md-3">
              ...
              <q-input v-model="gasto.total" placeholder="Obligatorio" type="number" :disable="disabled"
          ...
          <div class="col-12 col-md-3">
            ...
            <selector-imagen :imagen="gasto.comprobante1" @update:modelValue="(data) => (gasto.comprobante1 = data)">
            </selector-imagen>
          </div>
          ...
          <div class="col-12 col-md-3">
            ...
            <selector-imagen :imagen="gasto.comprobante2" @update:modelValue="(data) => (gasto.comprobante2 = data)">
            </selector-imagen>
          </div>
