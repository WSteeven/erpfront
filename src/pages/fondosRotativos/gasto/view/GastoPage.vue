        ...
        <div class="row q-col-gutter-sm q-mb-md">
          ...
          <div class="col-12 col-md-3">
            ...
            <q-select v-model="gasto.proyecto" :options="proyectos" transition-show="jump-up" transition-hide="jump-down"
              ...
              error-message="Debes seleccionar un canton" use-input input-debounce="0" @blur="v$.proyecto.$touch"
              @filter="filtrarProyectos" :option-value="(v) => v.id" :option-label="(v) => v.nombre" emit-value
              map-options>
              <template v-slot:error>
          ...
          <div class="col-12 col-md-3 q-mb-md">
            ...
            <q-select v-model="gasto.detalle" :options="detalles" transition-show="jump-up" transition-hide="jump-down"
              ...
              error-message="Debes seleccionar un canton" use-input input-debounce="0" @blur="v$.detalle.$touch"
          ...
          <div class="col-12 col-md-3">
            ...
            <selector-imagen :imagen="gasto.comprobante1" @blur="v$.comprobante1.$touch"
          ...
          <div class="col-12 col-md-3">
            ...
            <selector-imagen :imagen="gasto.comprobante2" @blur="v$.comprobante2.$touch"
          ...
          <div class="col-12 col-md-3">
            ...
            <q-input v-model="gasto.observacion" placeholder="Obligatorio" type="textarea" :disable="disabled" autogrow
              outlined dense>
            </q-input>
          </div>
          <div class="row q-col-gutter-sm q-mb-md q-my-xs" v-if="mostrarAprobacion">
              <div class="col-12 col-md-3 q-mx-md">
                <q-btn color="positive" @click="aprobar_gasto(gasto, 'aprobar')"> <q-icon
                    name="bi-check-circle" size="xs" class="q-mr-sm"></q-icon>Aprobar</q-btn>
              </div>
              <div class="col-12 col-md-3 q-mx-md">
                <q-btn color="negative" @click="aprobar_gasto(gasto, 'rechazar')"> <q-icon
                    name="bi-x-circle" size="xs" class="q-mr-sm"></q-icon>Rechazar</q-btn>
              </div>
            </div>
        </div>
      </q-form>
