      ...
      <q-form @submit.prevent>
        <div class="row q-col-gutter-sm q-mb-md">
          ...
          <div class="col-12 col-md-3">
            ...
            <q-input v-model="gasto.fecha_viat" placeholder="Obligatorio" disable outlined dense>
          ...
          <div class="col-12 col-md-3 q-mb-xl">
            <q-checkbox class="q-mt-lg q-pt-md" v-model="esFactura" label="¿Tiene Factura?" disable
          ...
          <div class="col-12 col-md-3" v-if="esFactura == false">
            ...
            <q-input v-model="gasto.num_comprobante" placeholder="Opcional" type="number" disable outlined dense>
            </q-input>
          </div>
          <!-- RUC -->
          <div class="col-12 col-md-3" v-if="esFactura">
            <label class="q-mb-sm block">RUC</label>
            <q-input v-model="gasto.ruc" placeholder="Obligatorio" type="number" disable outlined dense>
            </q-input>
          </div>
          <!-- Cantidad -->
          <div class="col-12 col-md-3">
            <label class="q-mb-sm block">Cantidad</label>
            <q-input v-model="gasto.cantidad" placeholder="Obligatorio" type="number" disable outlined dense>
            </q-input>
          </div>
          ...
          <div class="col-12 col-md-3">
            ...
            <q-input v-model="gasto.valor_u" placeholder="Obligatorio" type="number" disable outlined dense>
            </q-input>
          </div>
          <!-- Total -->
          <div class="col-12 col-md-3">
            <label class="q-mb-sm block">Total</label>
            <q-input v-model="gasto.total" placeholder="Obligatorio" type="number" disable outlined dense>
            </q-input>
          </div>
          ...
          <div class="col-12 col-md-3 q-mb-md">
            ...
            <q-input v-model="gasto.detalle_info" placeholder="Obligatorio" type="textarea" autogrow disable outlined
              dense></q-input>
          </div>
          <!-- Subdetalle-->
          <div class="col-12 col-md-3">
          ...
          <div class="col-12 col-md-3">
            ...
            <q-input v-model="gasto.placa" placeholder="Obligatorio" disable outlined dense>
            </q-input>
          </div>
          <!-- Kilometraje -->
          <div class="col-12 col-md-3">
            <label class="q-mb-sm block">Kilometraje</label>
            <q-input v-model="gasto.kilometraje" placeholder="Obligatorio" disable outlined dense>
            </q-input>
          </div>
          <!-- Observacion -->
          <div class="col-12 col-md-3">
            <label class="q-mb-sm block">Observación</label>
            <q-input v-model="gasto.observacion" placeholder="Opcional" type="textarea" disable autogrow outlined dense>
            </q-input>
          </div>
          <!-- Estado -->
          <div class="col-12 col-md-3">
          ...
          <div class="col-6 col-md-3">
            ...
            <selector-imagen-texto :imagen="gasto.comprobante1" :texto1="'R.U.C.: ' + gasto.ruc"
              :texto2="'Factura: ' + gasto.factura"
              :texto3="'Comprobante: ' + gasto.num_comprobante != null ? gasto.num_comprobante : ''"
              :texto4="'Empleado: ' + gasto.empleado_info" @update:modelValue="(data) => (gasto.comprobante1 = data)">
          ...
          <div class="col-6 col-md-3">
            ...
            <selector-imagen-texto :imagen="gasto.comprobante2" :texto1="'R.U.C.: ' + gasto.ruc"
              :texto2="'Factura: ' + gasto.factura"
              :texto3="'Comprobante: ' + gasto.num_comprobante != null ? gasto.num_comprobante : ''"
              :texto4="'Empleado: ' + gasto.empleado_info" @update:modelValue="(data) => (gasto.comprobante2 = data)">
            </selector-imagen-texto>
          </div>
        </div>
