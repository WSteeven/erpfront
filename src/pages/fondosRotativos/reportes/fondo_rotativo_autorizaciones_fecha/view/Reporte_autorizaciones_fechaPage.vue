    ...
    <q-card flat bordered class="my-card bg-grey-1">
      ...
      <q-card-section>
        ...
        <div class="row q-col-gutter-sm">
          <div class="col-12 col-md-6" v-if="!is_inactivo">
            <label class="q-mb-sm block">Empleado</label>
            <q-select
              v-model="reporte.usuario"
              :options="empleados"
          ...
          <div class="col-12 col-md-6" v-if="is_inactivo">
            ...
            <q-select
              ...
              :readonly="disabled"
              :error="!!v$.usuario.$errors.length"
              error-message="Debes seleccionar un empleado inactivo del listado"
              use-input
              input-debounce="0"
          ...
          <div class="col-12 col-md-3">
            <q-checkbox
              ...
              :true-value="true"
              :false-value="false"
              @update:model-value="() => (reporte.usuario = null)"
            ></q-checkbox>
          </div>
        </div>
      </q-card-section>
      ...
      <q-card-actions align="around">
        <q-btn color="positive" @click="generar_reporte('excel')">
          <q-icon
        ...
        <q-btn color="negative" @click="generar_reporte('pdf')">
          <q-icon
