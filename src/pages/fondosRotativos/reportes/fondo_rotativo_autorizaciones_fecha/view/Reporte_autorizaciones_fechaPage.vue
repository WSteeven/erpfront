<template>
  <q-page class="flex flex-center">
    <q-card flat bordered class="my-card bg-grey-1">
      ...
      <q-card-section>
        <!-- Usuarios -->
        <div class="col-12 col-md-3" v-if="is_inactivo == 'false'">
          <label class="q-mb-sm block">Empleado</label>
          <q-select
            v-model="fondo_rotativo_autorizacion_fecha.usuario"
            :options="usuarios"
      ...
      <q-card-actions align="around">
        <q-btn
          color="positive"
          @click="generar_reporte(fondo_rotativo_autorizacion_fecha, 'excel')"
        >
        ...
        <q-btn
          color="negative"
          @click="generar_reporte(fondo_rotativo_autorizacion_fecha, 'pdf')"
        >
