      ...
      <q-form @submit.prevent>
        <div class="row q-col-gutter-sm q-mb-md">
          ...
          <div class="col-12 col-md-4 q-mb-md">
            ...
            <q-select v-model="fondo.lugar" :options="cantones" transition-show="jump-up" transition-hide="jump-down"
              options-dense dense outlined :disable="disabled" :readonly="disabled" :error="!!v$.lugar.$errors.length"
              error-message="Debes seleccionar un canton" use-input input-debounce="0" @filter="filtrarCantones"
              :option-value="(v) => v.id" :option-label="(v) => v.canton" emit-value map-options>
          ...
          <div class="col-12 col-md-3">
            ...
            <q-input v-model="fondo.fecha_viat" placeholder="Obligatorio" :error="!!v$.fecha_viat.$errors.length"
              :disable="disabled" outlined dense>
              <template v-slot:append>
                <q-icon name="event" class="cursor-pointer">
                  <q-popup-proxy cover transition-show="scale" transition-hide="scale">
                    <q-date v-model="fondo.fecha_viat" mask="DD-MM-YYYY" today-btn>
          ...
          <div class="col-12 col-md-4 q-mb-md">
            ...
            <q-select v-model="fondo.proyecto" :options="proyectos" transition-show="jump-up" transition-hide="jump-down"
              options-dense dense outlined :disable="disabled" :readonly="disabled" :error="!!v$.proyecto.$errors.length"
              error-message="Debes seleccionar un canton" use-input input-debounce="0" @filter="filtrarProyectos"
          ...
          <!-- Tareas -->
          <div class="col-12 col-md-4 q-mb-md" v-if="fondo.proyecto >= 0">
          ...
          <div class="col-12 col-md-3">
            ...
            <q-input v-model="fondo.factura" placeholder="Obligatorio" mask="###-###-#########" fill-mask
              hint="###-###-#########" :disable="disabled" :error="!!v$.factura.$errors.length" @blur="v$.factura.$touch"
              outlined dense>
              <template v-slot:error>
          ...
          <div class="col-12 col-md-3">
            ...
            <q-input v-model="fondo.ruc" placeholder="Obligatorio" type="number" :disable="disabled"
            ...
            <div class="col-12 col-md-3">
              ...
              <q-input v-model="fondo.valor_u" placeholder="Obligatorio" type="number" :disable="disabled"
            ...
            <div class="col-12 col-md-3">
              ...
              <q-input v-model="fondo.total" placeholder="Obligatorio" type="number" :disable="disabled"
          ...
          <div class="col-12 col-md-3">
            ...
            <q-select v-model="fondo.aut_especial" :options="autorizacionesEspeciales" transition-show="jump-up"
          ...
          <div class="col-12 col-md-3 q-mb-md">
            ...
            <q-select v-model="fondo.detalle" :options="detalles" transition-show="jump-up" transition-hide="jump-down"
              options-dense dense outlined :disable="disabled" :readonly="disabled" :error="!!v$.detalle.$errors.length"
              error-message="Debes seleccionar un canton" use-input input-debounce="0" @filter="filtrarDetalles"
              :option-value="(v) => v.id" :option-label="(v) => v.descripcion" emit-value map-options>
              <template v-slot:error>
          ...
          <div class="col-12 col-md-4 q-mb-md" v-if="fondo.detalle != null">
            ...
            <q-select v-model="fondo.sub_detalle" :options="sub_detalles" transition-show="jump-up"
              transition-hide="jump-down" options-dense dense outlined :disable="disabled" :readonly="disabled"
              :error="!!v$.sub_detalle.$errors.length" error-message="Debes seleccionar un canton" use-input
          ...
          <div class="col-12 col-md-3">
            ...
            <selector-imagen :imagen="fondo.comprobante1" @update:modelValue="(data) => (fondo.comprobante1 = data)">
            </selector-imagen>
          </div>
          ...
          <div class="col-12 col-md-3">
            ...
            <selector-imagen :imagen="fondo.comprobante2" @update:modelValue="(data) => (fondo.comprobante2 = data)">
            </selector-imagen>
          </div>
          ...
          <div class="col-12 col-md-3">
            ...
            <q-input v-model="fondo.observacion" placeholder="Obligatorio" type="textarea" :disable="disabled"
              :error="!!v$.observacion.$errors.length" @blur="v$.observacion.$touch" outlined dense>
              <template v-slot:error>
