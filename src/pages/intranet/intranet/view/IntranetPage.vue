  ...
  <q-page padding>
    <div class="row q-col-gutter-sm q-mt-md q-mx-md q-mb-md">
      ...
      <div class="col-12 col-md-9 q-px-md">
        ...
        <div>
          <q-carousel v-if="noticias.length > 0" class="carousel-noticias" style="border-radius: 15px; overflow: hidden"
            ...
            <q-carousel-slide v-for="(news, index) in noticias" :key="index" :name="index"
              class="carousel-slide-noticias row q-py-md">
              <q-img :src="news.imagen_noticia" :alt="news.titulo"
                class="col-12 col-md-5 fixed-size-image noticias-image" style="border-radius: 15px" />
              <div class="col-12 col-md-7 q-pl-md">
                <h5 class="noticias-title q-mb-sm">{{ news.titulo }}</h5>
                <p class="noticias-description q-mb-md justify-text" v-html="getShortDescription(news.descripcion)"></p>
        ...
        <q-dialog v-model="modalNoticia" max-width="1000px" transition-show="scale" transition-hide="scale"
            ...
            <q-card-section class="noticia-modal-content">
              ...
              <div class="noticia-modal-header">
                ...
                <div class="noticia-modal-autor-container">
                  <span class="noticia-modal-autor">{{ noticiaCompleta?.autor }}</span>
                </div>
              </div>
              <div class="noticia-modal-body">
                <div class="noticia-modal-titulo">{{ noticiaCompleta?.titulo }}</div>
      ...
      <div class="col-12 col-md-3 q-px-md q-mt-md">
        ...
        <!--Sección de Vacantes-->
        <q-card flat bordered class="vacantes-card" style="border-radius: 15px; overflow: hidden">
          <q-expansion-item style="
              text-align-last: center;
        ...
        <q-card flat bordered class="solicitudes-card" style="border-radius: 15px; overflow: hidden">
          <q-expansion-item style="
              text-align-last: center;
              ...
              font-weight: bold;
              border-radius: 10px;
            " icon="bi-bookmark-heart" label="SOLICITUDES" :default-opened="false">
        ...
        <q-card class="eventos-card" style="border-radius: 25px; background-color: white">
          <q-expansion-item style="
              text-align-last: center;
              ...
              font-weight: bold;
              border-radius: 10px;
            " icon="bi-calendar-event" label="EVENTOS" :default-opened="true">
            ...
            <q-card-section style="background-color: white">
              <q-date v-model="selectedDate" :mask="maskFecha" :events="eventDates" :event-color="getColor" minimal
                @update:model-value="verEvento" style="
                  width: max-content;
                  color: black;
...
.noticia-modal-card {
  border-radius: 50px;
  overflow: hidden;
  position: relative; /* Añadir esta línea para posicionamiento relativo */
}
...
.noticia-modal-close-btn {
  ...
  right: 450px; /* Ajusta según sea necesario */
