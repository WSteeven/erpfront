  ...
  <q-page padding>
    <div class="row q-col-gutter-sm q-mx-md q-mb-md">
      <div
        ...
        :class="{ 'q-mt-xl': $q.screen.xs }"
      >
        <div class="text-h5 text-bold">Bienvendo</div>
      </div>
    </div>
    ...
    >
      <q-tab
        ...
        :key="opcion"
        :name="opcion + ''"
        class="bordde rounded shadow-chip q-my-xl bg-body q-pa-md q-mx-sm"
      >
    ...
    >
      <q-tab-panel :name="tabsOptions.NOTICIAS">
        <div class="row">
          <div class="col-12">
            <!-- Noticias -->
            <div class="q-mb-sm">
      ...
      <q-tab-panel :name="tabsOptions.MIS_MODULOS">
        <div class="row">
          <!--Mis Modulos-->
      ...
      <q-tab-panel :name="tabsOptions.DEPARTAMENTOS">
        <div class="row">
          <!-- Departamentos -->
