...
export default defineComponent({
  ...
  setup() {
    ...
    const events = ref([
      { time: { start: '2024-07-29 10:00:00', end: '2024-07-29 12:00:00' }, color: 'red', title: 'Reunión', description: 'Reunión de planificación' },
      { time: { start: '2024-07-30 11:00:00', end: '2024-07-30 13:00:00' }, color: 'blue', title: 'Presentación', description: 'Presentación del proyecto' }
    ]);
    ...
    const selfCenterMiddle: ComputedRef<'center middle' | 'top start'> = computed(() => $q.screen.xs ? 'center middle' : 'top start');
