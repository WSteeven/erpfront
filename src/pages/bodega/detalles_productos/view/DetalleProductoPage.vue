      ...
      <q-form @submit.prevent>
        <div class="row q-col-gutter-sm q-py-md">
          ...
          <div class="col-12 col-md-6">
            ...
            <q-select v-model="detalle.producto" :options="opciones_productos.productos" transition-show="scale"
              transition-hide="scale" options-dense dense outlined :error="!!v$.producto.$errors.length" use-input
              input-debounce="0" @filter="filterProductos" :option-label="(item)=> item.nombre"
          ...
          <div class="col-12 col-md-6">
            ...
            <q-input v-model="detalle.descripcion" placeholder="Obligatorio" :readonly="disabled"
              :error="!!v$.descripcion.$errors.length" @update:model-value="(v)=>(detalle.descripcion=v.toUpperCase())"
              outlined dense>
              <template v-slot:error>
          ...
          <div class="col-12 col-md-6">
            ...
            <q-input type="number" mask="##.##" fill-mask unmasked-value v-model="detalle.precio_compra"
              placeholder="Obligatorio" :readonly="disabled" @update:model-value="
              (v)=>(detalle.precio_compra=v.toUpperCase())" outlined dense>
            </q-input>
          </div>
          <!-- Tiene serial -->
          <div class="col-12 col-md-3">
            <br />
            <q-checkbox v-model="detalle.tiene_serial" label="Tiene serial" outlined dense></q-checkbox>
          </div>
          <!-- Es fibra -->
          <div class="col-12 col-md-3">
            <br />
            <q-checkbox v-model="detalle.es_fibra" label="Es fibra" outlined dense></q-checkbox>
          </div>
          <!-- Serial -->
          <div v-if="detalle.tiene_serial || detalle.es_fibra" class="col-12 col-md-6">
            ...
            <q-input v-model="detalle.serial" placeholder="Obligatorio" :readonly="disabled"
              :error="!!v$.serial.$errors.length" @update:model-value="
              (v)=>(detalle.serial=v.toUpperCase())" outlined dense>
              <template v-slot:error>
          ...
          <div v-if="detalle.es_fibra" class="col-12 col-md-6 q-mb-md">
            ...
            <q-select v-model="detalle.tipo_fibra" :options="opciones_fibras"
              ...
              options-dense dense outlined :error="!!v$.tipo_fibra.$errors.length" :option-label="(item) => item.nombre"
              :option-value="(item) => item.id" emit-value map-options>
              <template v-slot:error>
          ...
          <div v-if="detalle.es_fibra" class="col-12 col-md-6">
            ...
            <q-input type="tel" mask="####" unmasked-value suffix="metros" v-model="detalle.punta_a"
              placeholder="Opcional" :readonly="disabled" @update:model-value="
              (v)=>(detalle.punta_a=v.toUpperCase())" outlined dense>
            </q-input>
          </div>
          <!-- Punta B -->
          <div v-if="detalle.es_fibra" class="col-12 col-md-6">
            <label class="q-mb-sm block">Punta Final (B)</label>
            <q-input type="tel" mask="####" unmasked-value suffix="metros" v-model="detalle.punta_b"
              placeholder="Obligatorio" :readonly="disabled" :error="!!v$.punta_b.$errors.length" @update:model-value="
              (v)=>(detalle.punta_b=v.toUpperCase())" outlined dense>
              <template v-slot:error>
          ...
          <div v-if="detalle.es_fibra" class="col-12 col-md-6">
            ...
            <q-input type="tel" mask="####" unmasked-value suffix="metros" v-model="detalle.punta_corte"
              placeholder="Opcional" :readonly="disabled" @update:model-value="
              (v)=>(detalle.punta_corte=v.toUpperCase())" outlined dense>
            </q-input>
          </div>
        </div>
      </q-form>
