  ...
  setup(props, { emit }) {
    ...
    const btnEditarCantidadPendiente: CustomActionTable = {
      ...
      accion: ({ entidad, posicion }) => {
        ...
        console.log(
          'aquí se podrá modificar hacia arriba o hacia abajo la cantidad'
        )
        ingresarCantidad(entidad, posicion)
      },
      visible: () => transaccionStore.tab === estadosTransacciones.pendiente
    }
    ...
    const btnEditarCantidadParcial: CustomActionTable = {
      ...
      visible: ({ entidad }) =>
        transaccionStore.tab === estadosTransacciones.parcial &&
        entidad.pendiente > 0
    }
     ...
     * FUNCIONES
     **********************************/
    function ingresarCantidad(entidad: any, posicion: number) {
