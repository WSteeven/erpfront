...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    function buscarCantidadEnTransaccion(detalle) {
      let fila = transaccion.listadoProductosTransaccion.filter((v) => v.detalle_id === detalle)
      console.log(fila[0]['cantidad'])
      return fila[0]['cantidad']
    }
