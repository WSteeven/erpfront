...
export class ValidarListadoProductos implements Validador {
  ...
  async validar(): Promise<boolean> {
    ...
    if (this.pedido.listadoProductos.some((v) => v.cantidad == 0 || v.cantidad == null)) throw new Error('Debe ingresar una cantidad mayor a cero en todos los elementos del listado')
    return true
  }
}
