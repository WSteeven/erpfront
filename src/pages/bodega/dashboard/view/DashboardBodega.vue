<template>
  <q-page padding>
    ...
    <q-card
      class="q-mb-md rounded no-border custom-shadow"
      v-if="dashboard.tipo == DEVOLUCION"
    >
      <div
        class="row text-bold text-primary q-pa-md rounded items-center q-mb-md"
      >
        Información de Devoluciones de Bodega
      </div>
      <q-card-section>
        <div class="row q-col-gutter-sm q-mb-lg">
          <div class="col-12 col-md-12 q-mb-lg">
            <div class="row q-col-gutter-xs">
              ...
              >
                ...
                >
                  ...
                  <div class="text-bold">Cantidad de devoluciones creadas</div>
                </q-card>
              </div>
              <div v-if="cantDevolucionesPendientes > 0" class="col-6 col-md-3">
                <q-card class="rounded-card q-pa-md text-center full-height">
                  <div class="text-h3 text-primary q-mb-md">
                    {{ cantDevolucionesPendientes }}
                  </div>
                  <div>Cantidad de devoluciones pendientes de autorizar</div>
                </q-card>
              </div>
              <div v-if="cantDevolucionesAprobadas > 0" class="col-6 col-md-3">
                <q-card class="rounded-card q-pa-md text-center full-height">
                  <div class="text-h3 text-primary q-mb-md">
                    {{ cantDevolucionesAprobadas }}
                  </div>
                  <div>
                    Cantidad de devoluciones autorizadas pendientes de ser
                    ingresadas a bodega
                  </div>
                </q-card>
              </div>
              <div v-if="cantDevolucionesParciales > 0" class="col-6 col-md-3">
                <q-card class="rounded-card q-pa-md text-center full-height">
                  <div class="text-h3 text-primary q-mb-md">
                    {{ cantDevolucionesParciales }}
                  </div>
                  <div>
                    Cantidad de devoluciones parcialmente ingresadas a bodega
                  </div>
                </q-card>
              </div>
              <div v-if="cantDevolucionesCompletas > 0" class="col-6 col-md-3">
                <q-card class="rounded-card q-pa-md text-center full-height">
                  <div class="text-h3 text-primary q-mb-md">
                    {{ cantDevolucionesCompletas }}
                  </div>
                  <div>Cantidad de devoluciones completadas</div>
                </q-card>
              </div>
              <div v-if="cantDevolucionesCanceladas > 0" class="col-6 col-md-3">
                <q-card
                  class="rounded-card q-pa-md text-center full-height bg-negative text-white"
                >
                  <div class="text-h3 q-mb-md">
                  ...
                  <div>Cantidad de devoluciones canceladas/anuladas</div>
                </q-card>
              </div>
            </div>
          </div>
    ...
    >
      <div
        class="row text-bold text-primary q-pa-md rounded items-center q-mb-md"
      >
        Gráficos Estadísticos de Devoluciones a Bodega
      </div>
      <q-tab-panels
        v-model="tabs"
        animated
