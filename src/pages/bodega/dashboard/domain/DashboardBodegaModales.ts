...
import VisualizarDevolucionPage from 'pages/bodega/devoluciones/view/VisualizarDevolucionPage.vue';
...
export class DashboardBodegaModales{
  ...
  constructor(){
    ...
    this.VisualizarDevolucionPage = markRaw(new ComponenteModal('Devolución de materiales a bodega',VisualizarDevolucionPage))
  }
}
