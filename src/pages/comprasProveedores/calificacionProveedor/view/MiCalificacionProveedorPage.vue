<template>
  <div class="q-pa-md">
    ...
    <q-expansion-item
        v-if="mi_calificacion!=undefined"
      class="overflow-hidden q-mb-md expansion"
      v-bind:label="
        'Calificaciones del departamento ' +
        mi_calificacion.calificacion.departamento
      "
      header-class="text-bold bg-header-collapse"
      default-opened
    >
      <div class="row q-col-gutter-sm q-pa-sm">
        ...
        <div
          ...
          v-if="
            listadoFiltrado(mi_calificacion.calificaciones_detalladas, 'bienes')
              .length > 0
          "
        >
          <essential-table
            ...
            :datos="
              listadoFiltrado(
                mi_calificacion.calificaciones_detalladas,
                'bienes'
              )
            "
      ...
      <div class="row q-col-gutter-sm q-pa-sm">
        <div class="col-12 col-md-12">
          <q-card flat bordered>
            <q-card-section>
              <div class="text-h5">
                Empleado: {{ mi_calificacion.calificacion.empleado }}
              </div>
            </q-card-section>
            <q-card-section>
              <div class="text-h6">
                Tu calificación personal es:
                {{ mi_calificacion.calificacion.calificacion }}/100
              </div>
            </q-card-section>
            <q-card-section>
              <div class="text">
                ...
                <strong>{{
                  mi_calificacion.calificacion.fecha_calificacion
                }}</strong>
              </div>
            </q-card-section>
          </q-card>
