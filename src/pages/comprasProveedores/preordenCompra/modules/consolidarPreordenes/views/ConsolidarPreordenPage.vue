<template>
  <!-- <q-page padding> -->
    <essential-selectable-table
      :configuracion-columnas="configuracionColumnasItemsPreorden"
      :datos="listado"
    />
    <essential-table
      ref="refListado"
      titulo="Listado de items"
      :configuracionColumnas="configuracionColumnasItemsPreorden"
      :datos="listado"
...
<script src="./ConsolidarPreordenPage.ts"></script>
