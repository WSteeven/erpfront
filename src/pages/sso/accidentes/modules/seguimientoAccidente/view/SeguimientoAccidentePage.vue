        ...
        <template #formulario>
          <div class="row q-col-gutter-xs">
            <div class="col-12 q-my-md">
              <small class="text-bold">Parte médica</small>
              <q-separator></q-separator>
            </div>

            <p class="text-grey-8">
              Seguimiento realizado por el responsable médico de la institución.
            </p>
            ...
            <div class="col-12">
              <label class="q-mb-sm block"
                ...
                accidente, diagramas, videos u otros tipos de evidencias)</label
              >
              <gestor-archivos
                ref="refArchivo"
