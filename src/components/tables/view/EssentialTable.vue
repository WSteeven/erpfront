<template>
  ...
  >
    ...
    <template #body-cell-facturable="props">
      <q-td :props="props">
        <q-chip v-if="props.value == true" :class="{ 'bg-green-1': !$q.dark.isActive }"
...
.my-sticky-header-column-table {
  ...
  thead tr:first-child th,thead tr:last-child th {
    top: 0;
    z-index: 1;
  }

  tr:first-child th:first-child,tr:last-child th:last-child {
    /* highest z-index */
    z-index: 3;
  }
